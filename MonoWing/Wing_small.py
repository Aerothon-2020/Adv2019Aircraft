...
#
# Set the airfoils
Wing.Airfoil = 'E423'  #'E423_M' #'S1223' 
...
Wing.Aileron.Fb = 1-0.61 #Adjusted to make Aileron begin at a Wing rib
...
Wing.Aileron.Servo.Weight = 0.92*OZF
Wing.Aileron.Servo.Torque = 62.5*IN*OZM
